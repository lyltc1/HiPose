...
class PSPNet(nn.Module):
    def __init__(
        ...
        elif backend.startswith('convnext'):
            import timm.models.convnext as convnext_extractors
            self.feats = getattr(convnext_extractors, backend)(pretrained=pretrained)
        self.psp = PSPModule(psp_size, 1024, sizes)
        self.drop_1 = nn.Dropout2d(p=0.3)

        self.up_1 = PSPUpsample(1024+512, 256)
        self.up_2 = PSPUpsample(256+256, 64)
        self.up_3 = PSPUpsample(64+128, 64)
