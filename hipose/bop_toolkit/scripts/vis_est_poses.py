...
p = {
  ...
  'result_filenames': [
    '/home/z3d/data/6dof_pose_experiments/experiments/self_defined/pose_result_bop/hipose_lmo-test.csv',
  ],
  ...
  'vis_path': os.path.join('/home/z3d/data/6dof_pose_experiments/experiments/self_defined/pose_result_bop', 'vis_est_poses'),
